...
<!-- Main header end -->
<!-- Contact Form starts-->
  <section id="contact" style="margin-top: 7%; margin-bottom: 7%">
			<div class="section-content">
				<h1 class="section-header" style="margin-left: 14%">Get in <span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s"> Touch with us</span></h1>
