...
<div class="contact-bg overview-bgi" style="background-color: #e5e549">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-content-box">
                    ...
                    <div class="details">
                        ...
                        <form action="signupcheck.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="password" name="password" class="input-text" placeholder="Password" id="passowrd">
                            </div>
                            <!--<div class="form-group">
                                <input type="password" name="confirm_Password" class="input-text" placeholder="Confirm Password" id="password">
                            </div>-->
                            <div class="mb-0">
